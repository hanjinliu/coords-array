...
from typing import TYPE_CHECKING, Iterable, Union, SupportsInt, Mapping, Any
from enum import Enum
import numpy as np
from numpy.typing import DTypeLike

from ._mixin import AxesMixin
...
class CoordsArray(np.ndarray, AxesMixin):
    ...
    def __repr__(self) -> str:
        if self.ndim > 0:
            return AxesMixin.__repr__(self)
        return self.value[()]
    ...
    def __getitem__(self, key: SupportSlicing) -> Self:
        ...
        if isinstance(out, self.__class__):  # cannot set attribution to such as numpy.int32 
            out._set_info(self, coords=axesop.slice_axes(self.coords, key))
    ...
    def __array_function__(self, func, types, args, kwargs):
        ...
        if (func in self.__class__.NP_DISPATCH and 
            all(issubclass(t, CoordsArray) for t in types)):
    ...
    def transpose(self, axis_names) -> Self:
        ...
        out._set_info(self, coords=new_coords)
        return out
    ...
    def broadcast_to(
        ...
        out._set_info(self, coords=coords)
        return out
    ...
    def _inherit_meta(self, obj: AxesMixin, ufunc, **kwargs):
        ...
        self._set_info(obj, coords=new_axes)
        return self
